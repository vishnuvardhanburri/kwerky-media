...
export function AnimatedNavFramer() {
  ...
  return (
    <>
      {isTouchLayout ? (
        <>
          <div className="fixed inset-x-3 top-3 z-50">
            ...
            {isMobileOpen ? (
              <>
                ...
                <motion.div
                  ...
                  className="fixed inset-x-3 top-20 z-50 rounded-[2rem] border border-white/10 bg-[#09090b]/96 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop-blur-xl"
                >
                  <div className="mb-4">
