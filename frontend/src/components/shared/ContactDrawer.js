  ...
  return (
    <Sheet open={isContactOpen} onOpenChange={(open) => (open ? undefined : closeContactInfo())}>
      <SheetContent side="right" className="w-[min(100vw-0.5rem,27rem)] border-white/10 bg-[#111111] p-0 text-white shadow-[0_30px_90px_rgba(0,0,0,0.7)]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(255,179,71,0.14),transparent_34%),radial-gradient(circle_at_top_left,rgba(37,99,235,0.2),transparent_30%)]" />
        <div className="relative h-full overflow-y-auto px-5 py-6 sm:px-6">
          ...
          <div className="space-y-6 py-6">
            <div className="rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-5">
              ...
              <div className="mt-5 space-y-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-[#ffb347]/20 bg-[#ffb347]/10 text-[#ffb347]">
                    <Phone className="h-5 w-5" />
                  </div>
                  <div>
                    <p className="text-lg font-semibold text-white">Phone</p>
                    <a href="tel:08031548088" className="mt-1 block text-white/68 hover:text-[#ffb347]">
                      08031548088
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@kwerkymedia.com" className="mt-1 block break-words text-white/68 hover:text-[#ffb347]">
                ...
                {SOCIAL_LINKS.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className="flex h-11 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-white/70 transition-colors hover:border-[#ffb347]/30 hover:text-[#ffb347]"
                    >
            ...
            <motion.button
              ...
              className="w-full rounded-full bg-blue-600 px-5 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#ffb347] hover:text-black"
            >
