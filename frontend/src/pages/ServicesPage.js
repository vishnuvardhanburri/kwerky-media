...
const ServicesPage = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }} className="relative min-h-screen bg-black pt-20">
      <BackgroundLayers />

      <section className="relative section-deep px-6 py-24" data-testid="services-hero">
        <div className="container relative z-10 mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.92fr_1.08fr]">
          <RevealOnScroll>
            <div className="text-left">
              ...
              <h1 className="torch-text text-5xl font-bold leading-[0.96] text-white md:text-7xl">
                <span className="text-blue-300">Why Choose</span> <span className="text-blue-300">Kwerky</span> <span className="text-[#ffb347]">Media?</span>
              </h1>
              <p className="mt-6 max-w-xl text-base text-white/78 md:text-lg">
            ...
            <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#050b16] shadow-[0_24px_90px_rgba(0,0,0,0.45)]">
              <div className="grid gap-4 p-5 md:grid-cols-[1.35fr_0.65fr] md:p-6">
                <div className="overflow-hidden rounded-[1.5rem] border border-white/10">
                  <img src="/brand/services-promo.jpg" alt="Kwerky Media services promo" className="aspect-[4/3] h-full w-full object-cover md:aspect-[5/4]" />
                </div>
          ...
          <RevealOnScroll>
            <div className="mb-10 text-center">
              <h2 className="torch-text text-4xl font-bold text-white md:text-6xl">
                <span className="text-blue-300">Content</span> <span className="text-[#ffb347]">Solutions</span>
              </h2>
            ...
            {services.map((service, index) => (
              <Card3D key={service.title} delay={index * 0.06} testId={`service-detail-${index}`}>
                <section
                  ...
                  className="relative z-[1] scroll-mt-28 rounded-[1.75rem] border border-white/10 bg-[#050b16] p-7 shadow-[0_18px_60px_rgba(0,0,0,0.35)] md:p-9"
                >
      ...
      <section id="services-video" className="relative section-deep px-6 py-20" data-testid="services-video">
        <div className="container relative z-10 mx-auto max-w-5xl">
          <RevealOnScroll>
            <div className="mb-10 text-center">
              <p className="mb-4 text-xs font-semibold uppercase tracking-[0.34em] text-blue-300/80">Videos</p>
              <h2 className="text-4xl font-bold text-white md:text-6xl">
                <span className="text-blue-300">Explore</span> <span className="text-blue-300">our Kwerky</span> <span className="text-[#ffb347]">videos</span>
              </h2>
            </div>
          </RevealOnScroll>
          <RevealOnScroll delay={0.1}>
      ...
      <section id="contact-info-section" className="relative section-blue px-6 py-24" data-testid="contact-info-section">
        <div className="container relative z-10 mx-auto max-w-6xl">
          <RevealOnScroll>
              ...
              <div className="rounded-[2rem] border border-white/10 bg-[#050b16] p-6 shadow-[0_24px_90px_rgba(0,0,0,0.45)] md:p-8">
                <div className="grid gap-5 sm:grid-cols-3">
                  <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.03] p-5">
                    ...
                    <a href="tel:08031548088" className="mt-2 block text-lg font-semibold text-white">08031548088</a>
                  </div>
                  <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.03] p-5">
                    <Mail className="h-5 w-5 text-blue-300" />
                    <p className="mt-4 text-xs uppercase tracking-[0.28em] text-white/45">Email</p>
                    <a href={buildMailto()} className="mt-2 block break-words text-lg font-semibold text-white">{EMAIL_ADDRESS}</a>
                  </div>
                  <div className="rounded-[1.35rem] border border-white/10 bg-white/[0.03] p-5">
